...
async def run_test():
    with open("/Users/ashishjangde/moviees/application/api/scripts/multi_asset_strategy.json", "r") as f:
    ...
    async with AsyncSessionLocal() as session:
        ...
        for s in snapshots:
            ...
            if abs(s.equity - expected_eq) > 0.01:
                print(f"Mismatch at {s.timestamp}! Equity: {s.equity}, Expected: {expected_eq}")
