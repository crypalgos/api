...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('is_code_modified', sa.Boolean(), nullable=False, server_default=sa.text('false')),
    ...
    op.create_table(
        ...
        sa.Column('initial_capital', sa.Float(), nullable=False, server_default=sa.text('10000.0')),
